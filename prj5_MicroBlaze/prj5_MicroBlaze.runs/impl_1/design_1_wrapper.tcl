...
set rc [catch {
  ...
  add_files -quiet H:/workSpace/xilinx/D7C/prj5_MicroBlaze/prj5_MicroBlaze.runs/synth_1/design_1_wrapper.dcp
  ...
  set_param project.isImplRun true
  link_design -top design_1_wrapper -part xc7a35tcsg324-1
  set_param project.isImplRun false
